...
import 'package:flutter_application_test/gallery_item.dart';
...
class DetailWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final index = ModalRoute.of(context)!.settings.arguments as int; // Index
    ...
    return SafeArea(
      child: Scaffold(
        ...
        body: ListView(
          ...
          children: [
            Image(image: AssetImage(galleryData[index].imagePath), height: 400, width: 200, fit: BoxFit.cover),
            Text(
            ...
            Text(galleryData[index].imageDescription, style: TextStyle(fontSize: 16), textAlign: TextAlign.left),
          ], // children
        ),
      ),
    );
